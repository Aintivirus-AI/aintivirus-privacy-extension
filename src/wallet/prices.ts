...
const COINGECKO_TOKEN_PRICE_SOLANA_API = 'https://api.coingecko.com/api/v3/simple/token_price/solana';
const COINGECKO_TOKEN_PRICE_ETHEREUM_API = 'https://api.coingecko.com/api/v3/simple/token_price/ethereum';
