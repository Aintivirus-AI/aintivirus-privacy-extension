// Lightweight Anchor IDL cache/decoder used by security analyses to label Solana programs.
...
const KNOWN_IDL_SOURCES: Record<string, string> = {
  JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4:
    'https://raw.githubusercontent.com/jup-ag/jupiter-core/main/idl/jupiter.json',
};
...
function decodeArgs(data: Buffer, offset: number, args: AnchorArg[]): Record<string, unknown> {
